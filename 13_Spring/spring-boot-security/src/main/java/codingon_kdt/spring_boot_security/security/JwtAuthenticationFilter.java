...
@Slf4j
@Component // Spring component 등록
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    // OncePerRequestFilter: 한 요청당 반드시 한번만 실행
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            String token = parseBearerToken(request);   // req 에서 토큰 꺼내오기
        ...
        // 필터 체인을 계속 진행(필터1->필터2->필터3)등 다음 필터로 계속 넘어간다.
